...
(sdegeo:create-rectangle (position 0 0 0) (position 1 2 0) "Silicon" "p_region")
(sdegeo:create-rectangle (position 0 2 0) (position 1 4 0) "Silicon" "n_region")
...
(sdegeo:set-contact-edges (list (car (find-edge-id (position 0.5 4 0)))) "n_contact")

;doping

(sdedr:define-constant-profile "p_dop" "BoronActiveConcentration" 1e16)
...
(sdedr:define-refeval-window "junction-mesh-region" "rectangle" (position 0 1 0) (position 1 3 0))
